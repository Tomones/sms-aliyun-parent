...
import static com.github.sms.aliyun.Utils.*;
...
public class SmsClient {
    ...
    public void send(final SmsTemplate smsTemplate) {
        ...
        request.setSysDomain(StringUtils.isEmpty(smsTemplate.getSmsDomain()) ? "dysmsapi.aliyuncs.com" : smsTemplate.getSmsDomain());
